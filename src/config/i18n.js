...
export const I18N = {
  ...
  preset_prompt_trade_english: {
    zh: `外贸英语学习卡`,
    en: `Foreign Trade English Learning Card`,
    zh_TW: `外貿英語學習卡`,
    ja: `外国貿易英語学習カード`,
    ko: `대외무역 영어 학습 카드`,
    tr: `Dış Ticaret İngilizcesi Öğrenme Kartı`,
    vi: `Thẻ học tiếng Anh ngoại thương`,
  },
  inject_rules: {
    zh: `注入订阅规则`,
  ...
  trade_term_learning: {
    zh: `外贸英语拆解`,
    en: `Foreign Trade English Breakdown`,
    zh_TW: `外貿英語拆解`,
    ja: `外国貿易英語の分解`,
    ko: `대외무역 영어 분석`,
    tr: `Dış Ticaret İngilizcesi Analizi`,
    vi: `Phân tích tiếng Anh ngoại thương`,
  },
  trade_term_learning_helper: {
    zh: `划词后用 AI 解释英文表达、缩写、组合逻辑和外贸用法；中文输入会先生成自然英文。`,
    en: `Use AI to explain English expressions, abbreviations, composition, and trade usage. Chinese input is converted to natural English first.`,
    zh_TW: `劃詞後用 AI 解釋英文表達、縮寫、組合邏輯和外貿用法；中文輸入會先產生自然英文。`,
    ja: `選択した表現の略語、構成、貿易での用法を AI が解説します。中国語は自然な英語にしてから分析します。`,
    ko: `선택한 표현의 약어, 구성 및 무역 용례를 AI가 설명합니다. 중국어는 자연스러운 영어로 변환한 뒤 분석합니다.`,
    tr: `AI; seçilen ifadenin kısaltmalarını, yapısını ve ticari kullanımını açıklar. Çince giriş önce doğal İngilizceye çevrilir.`,
    vi: `AI giải thích từ viết tắt, cấu tạo và cách dùng trong ngoại thương. Tiếng Trung được chuyển sang tiếng Anh tự nhiên trước.`,
  },
  trade_term_api: {
    zh: `外贸英语接口`,
    en: `Trade English API`,
    zh_TW: `外貿英語介面`,
    ja: `外国貿易英語 API`,
    ko: `대외무역 영어 API`,
    tr: `Dış Ticaret İngilizcesi API'si`,
    vi: `API tiếng Anh ngoại thương`,
  },
  trade_term_prompt: {
    zh: `外贸英语提示词`,
    en: `Trade English Prompt`,
    zh_TW: `外貿英語提示詞`,
    ja: `外国貿易英語プロンプト`,
    ko: `대외무역 영어 프롬프트`,
    tr: `Dış Ticaret İngilizcesi İstemi`,
    vi: `Lời nhắc tiếng Anh ngoại thương`,
  },
  trade_term_loading: {
    zh: `正在分析英文表达…`,
    en: `Analyzing the English expression…`,
    zh_TW: `正在分析英文表達…`,
    ja: `英語表現を分析しています…`,
    ko: `영어 표현을 분석하는 중…`,
    tr: `İngilizce ifade analiz ediliyor…`,
    vi: `Đang phân tích cách diễn đạt tiếng Anh…`,
  },
  smart_tts: {
    zh: `智能朗读`,
    en: `Smart Read Aloud`,
  ...
  speak_core_expression: {
    zh: `朗读核心英文表达`,
    en: `Read the core English expression`,
    zh_TW: `朗讀核心英文表達`,
    ja: `主要な英語表現を読み上げ`,
    ko: `핵심 영어 표현 읽기`,
    tr: `Temel İngilizce ifadeyi oku`,
    vi: `Đọc cách diễn đạt tiếng Anh cốt lõi`,
  },
  pause_speech: {
    zh: `暂停朗读`,
    en: `Pause reading`,
